...
<div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
                ...
                <div class="mt-4 md:mt-0">
                    <div class="bg-blue-50 border-l-4 border-blue-500 px-4 py-3 rounded">
                        <p class="text-sm text-blue-800">
                            ...
                            No. Pendaftaran: <strong>#{{ str_pad($siswa->SISWA_ID, 4, '0', STR_PAD_LEFT) }}</strong> 
                        </p>
                    </div>
                </div>
                @endif
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-4 space-y-2">
                            <div class="flex items-center text-sm text-gray-600">
                                ...
                                <span>Terbit: {{ tanggal($siswa->SISWA_TGL_DAFTAR, "LONG") }}</span>
                            </div>
                            <div class="flex items-center text-sm text-gray-600">
                        ...
                        <p class="text-sm text-gray-600 mb-4">
                            Kartu identitas pendaftaran yang wajib dibawa saat verifikasi berkas dan tes seleksi.
                        </p>

                        <!-- Actions -->
                        <div class="flex flex-col space-y-2">
                            <button onclick="downloadKartu('kartu-pendaftaran')" class="w-full bg-blue-600 text-white px-4 py-2.5 rounded-lg font-semibold hover:bg-blue-700 transition flex items-center justify-center">
                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-400 p-3 mb-4">
                            <p class="text-xs text-blue-800">
                                ...
                                Kartu akan tersedia setelah mendaftar
                            </p>
                        </div>
        ...
        <!-- Info Banner -->
        <div class="mt-8 bg-blue-500 rounded-lg shadow-lg p-6 text-white">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-blue-100">
                        <li class="flex items-start">
                            ...
                            <span>Pastikan Anda mencetak dan membawa kartu saat verifikasi dan tes di Madrasah</span>
                        </li>
                        <li class="flex items-start">
                            <i class="fas fa-check-circle mr-2 mt-1"></i>
...
function downloadKartu(jenis){
    window.open("{{ url('/public/excel') }}/" + jenis + "?siswaId=" + siswaId, "_blank")
}
